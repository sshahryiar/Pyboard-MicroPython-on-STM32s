...
class TFT114(framebuf.FrameBuffer):
    ...
    def __init__(self):
        ...
        self.ST7789_CS = Pin(ST7789_CS_pin, Pin.OUT_PP)
        ...
        self.ST7789_SPI = SPI(1, SPI.CONTROLLER, baudrate = 10_000_000, polarity = 1, phase = 1, bits = 8, firstbit = SPI.MSB)
