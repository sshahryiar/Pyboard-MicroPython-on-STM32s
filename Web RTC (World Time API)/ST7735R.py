...
class TFT_18(framebuf.FrameBuffer):
    ...
    def __init__(self):
        ...
        self.ST7735_SPI = SPI(1, SPI.CONTROLLER, baudrate = 10_000_000, polarity = 0, phase = 0)
    ...
    def TFT_init(self):
        ...
        self.send((ST7735_MADCTL_MY | ST7735_MADCTL_MV | ST7735_MADCTL_ML), DAT)   
