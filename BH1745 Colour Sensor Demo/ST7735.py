...
class TFT_7735(framebuf.FrameBuffer):
    ...
    def __init__(self):
        ...
        self.ST7735_CS = Pin(ST7735_CS_pin, Pin.OUT_PP)
        self.ST7735_RST = Pin(ST7735_RST_pin, Pin.OUT_PP)
        self.ST7735_SCK = Pin(ST7735_SCK_pin, Pin.OUT_PP)
        self.ST7735_MOSI = Pin(ST7735_MOSI_pin, Pin.OUT_PP)

        self.ST7735_SPI = SPI(1, SPI.CONTROLLER, baudrate = 10000000, polarity = 0, phase = 0)
        
        self.ST7735_DC = Pin(ST7735_DC_pin, Pin.OUT_PP)
    ...
    def TFT_init(self):
        ...
        self.send((ST7735_MADCTL_MV | ST7735_MADCTL_MX | ST7735_MADCTL_RGB), DAT)
        
        self.send(ST7735_INVON, CMD)
        self.send(ST7735_NORON, CMD)
